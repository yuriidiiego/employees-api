...
public class EnderecoResponseDTO implements Serializable {
  ...
  @Valid private String bairro;

  @Valid private String cep;

  @Valid private String cidade;

  @Valid private String complemento;

  @Valid private String endereco;

  @Valid private String uf;
